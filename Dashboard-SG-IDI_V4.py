...
# Toda la app dentro de try/except: si hay error, aparece en pantalla en vez de blanco
try:
    import pandas as pd
    ...
    st.error("Error al iniciar la app: " + str(_boot_err))
    st.stop()
